...
#import "EHFixedWidthItemsSingleAnimatedSelectionSeparatorView.h"
...
FOUNDATION_EXPORT double EHHorizontalFixedWidthItemsViewVersionNumber;
FOUNDATION_EXPORT const unsigned char EHHorizontalFixedWidthItemsViewVersionString[];
